...
(function () {
  ...
  var PREMIUM_FEATURES = {
    ...
    vocabularyExpansion: { key: 'vocabulary-expansion', label: 'Vocabulary Expansion', description: 'Unlock the full Quranic vocabulary — all 1,208 words (free includes the top 300)' },
