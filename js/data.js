...
// Completing all 10 lessons recognizes ~21% of all Quran word tokens (real token-level coverage).
...
// of the Quran" claim); the real measured coverage is ~24% for the full
// 901-word set and ~21% for the Foundation Course's 100 words.
// ═══════════════════════════════════════════════════════════════
