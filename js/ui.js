...
function setView(viewName) {
  ...
  var views = ['dashboard', 'learn', 'quiz', 'list', 'quran', 'explorer', 'auth', 'profile', 'settings'];
...
function renderDashboard() {
  ...
  if ($heroStreak) {
    $heroStreak.onclick = function() { switchView('profile'); };
    $heroStreak.onkeydown = function(e) { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); switchView('profile'); } };
  }
  ...
  if ($heroCoverage) {
    $heroCoverage.onclick = function() { switchView('profile'); };
    $heroCoverage.onkeydown = function(e) { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); switchView('profile'); } };
  }
