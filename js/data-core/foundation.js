...
// Real token-level coverage (verified): ~43.1% for the full 1207-word set,
// ~29.9% for the Foundation Course's 100 words.
...
// of the Quran" claim); the real measured coverage is ~43.1% for the full
// 1207-word set and ~29.9% for the Foundation Course's 100 words.
// ═══════════════════════════════════════════════════════════════
...
function calculateCoverage() {
  ...
  // Coverage is now REAL token coverage (max ~43% for the full 1207-word set), so
 ...
 * Returns the REAL measured percentage (~29.9), or 0 if unavailable.
 */
