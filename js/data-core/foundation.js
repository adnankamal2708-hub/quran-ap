...
function buildFoundationCourse() {
  ...
  for (var li = 0; li < FOUNDATION_LESSON_COUNT; li++) {
    ...
    var lessonContexts = [
      ...
      'Final review of all 100 foundation words.' + (cumulativeCoverageNum > 0 ? ' After this you recognize approximately {coverage}% of all Quranic word occurrences.' : ''),
    ];
...
/**
 * Real coverage percentage of the full Foundation Course word set (~29%),
...
function calculateCoverage() {
  ...
  // Coverage is now REAL token coverage (max ~34% for the full set), so
...
// ~33.7% (full 930-word set) / ~29.0% (Foundation Course). Tiers above that
